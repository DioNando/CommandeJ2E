        ...
        <div class="modal-content text-dark">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex flex-column">
                    ...
                    <input class="my-2 form-control" type="text" name="idClientToUpdate" id="idClientToUpdate" autocomplete="off" required>
                </div>
                <div class="d-flex flex-column">
        ...
        $(document).ready(function () {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $("#modalLabelUpdate").html("Modification du client " + result.num);
                    $("#modalLabelDelete").html("Suppression du client " + result.num);
                    $("#numClientToUpdate").val(result.num);
                    $("#idClientToUpdate").val(result.id);
                    $("#nomClientToUpdate").val(result.nom);
                },
                error: function () {
    ...
    function updateClient() {
        $(document).ready(function () {
            $.ajax({
                ...
                data: {
                    submit: "Modifier",
                    numClient: $("#numClientToUpdate").val(),
